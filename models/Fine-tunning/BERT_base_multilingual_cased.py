...
training_args = TrainingArguments(  
    output_dir="./results/google-bert/bert-base-multilingual-uncased_fine_tuning",
    eval_strategy="epoch",
    save_strategy="epoch",
    learning_rate=2e-5,
...
os.makedirs("./results/google-bert/bert-base-multilingual-uncased_fine_tuning", exist_ok=True),

evaluate_model(
    y_true=true_labels,
    y_pred=pred_labels,
    model_name="bert-base-multilingual-uncased_fine_tuning_3"
)
