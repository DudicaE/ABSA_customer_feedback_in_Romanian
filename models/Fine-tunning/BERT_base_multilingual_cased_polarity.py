...
for aspect in LABEL_COL_NAME[1:]:
    ...
    training_args = TrainingArguments(
        output_dir=f"./results/google-bert/bert-base-multilingual-uncased_fine_tuning_polarity_{aspect}",
        eval_strategy="epoch",
        save_strategy="epoch",
        learning_rate=2e-5,
    ...
    evaluate_model_per_aspect(y_true=labels, y_pred=preds, model_name=f"bert-base-multilingual-uncased_fine_tuning_polarity", aspect=aspect)